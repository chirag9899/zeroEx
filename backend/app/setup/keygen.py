...
PARTIES = 3  # number of parties that will be involved in the protocol
...
def initialize_distributed_schemes():
    local_ports = [8500 + i for i in range(PARTIES)]
    local_pools = [setup_local_pool(server_port, local_ports) for server_port in local_ports]
    ...
    distributed_paillier_schemes = loop.run_until_complete(asyncio.gather(*async_coroutines))
    ...
    # Serialize and save the private keys and shares
...
if __name__ == "__main__":
    initialize_distributed_schemes()
